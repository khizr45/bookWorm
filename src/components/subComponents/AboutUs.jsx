    ...
    <div className='h-[80vh] aboutusHeight p-4'>
      ...
      <div className='flex justify-around items-center w-[88vw] aboutus'>
        ...
        <div className='flex justify-between items-center w-[50%] mt-4 aboutus gap-8 ml-16'>
            <div className='flex flex-col justify-start items-center w-[75%] h-[60vh] border-4 border-[#FFCE31] rounded-lg firstbox'>
            ...
            <div className='flex flex-col justify-start items-center w-[80%] h-[60vh] border-4 border-[#FFCE31] rounded-lg  firstbox'>
