  ...
  return (
    <div>
      ...
      <div className='flex justify-start items-center w-[98.7vw] mt-12 ml-40 boxes'>
        <div className='w-[30rem] h-[16rem] bg-[#FFCE31] flex flex-col justify-start items-center text-center rounded-tl-3xl box bordergiven1'>
            <img src='seamless.svg' className='mt-4 h-[3rem] featureshead'/>
        ...
        <div className='w-[30rem] h-[16rem] bg-[#FFCE31] ml-8 flex flex-col justify-start items-center text-center border-r-8 border-black borderBox box bordergiven1'>
            <img src='marketplace.svg' className='mt-4 h-[3] featureshead'/>
      ...
      <div className='flex justify-start items-center w-[98.7vw] mt-8 ml-40 boxes'>
            <div className='w-[30rem] h-[16rem] bg-[#FFCE31] flex flex-col justify-start items-center text-center border-b-8 border-black borderBox specialborderbox box bordergiven1'>
                <img src='books.svg' className='mt-4 h-[3rem] featureshead'/>
                <p className='mt-4 text-black font-medium font-poppins text-lg'>Effortlessly buy, rent, or borrow books with<br/> transparent pricing based on condition<br/> and availability.</p>
            </div>
